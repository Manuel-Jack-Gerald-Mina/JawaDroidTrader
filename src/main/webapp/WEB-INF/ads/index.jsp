...
<%--              &lt;%&ndash;<c:param name="userid" value="${ad.userId}" />&ndash;%&gt;--%>
<%--                    &lt;%&ndash;<h5 class="card-title">${param.userbyid}</h5>&ndash;%&gt;--%>
...
<%--                     <input type="hidden" name="EditAdId" value="${ad.id}">--%>
<%--                     <input class="btn btn-warning btn-sm" type="submit" value="Edit">--%>
<%--&lt;%&ndash;                     <a href="/ads/edit">edit</a>&ndash;%&gt;--%>
<%--                 </form>--%>
<%--&lt;%&ndash;                 <form>&ndash;%&gt;--%>
<%--&lt;%&ndash;                 <button  name="edit">Edit</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                 </form>&ndash;%&gt;--%>
<%--             </c:if>--%>
<%--            </div>--%>
<%--            </div>--%>
