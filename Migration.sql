...
(
    id  INT UNSIGNED NOT NULL AUTO_INCREMENT,
    url VARCHAR(50)  NOT NULL DEFAULT 'Adsimg/Beskar.png',
    PRIMARY KEY (id)
);
...
(
    ...
    adpicture_id INT UNSIGNED NOT NULL,
    FOREIGN KEY (ad_id) REFERENCES ads (id)
        ON DELETE CASCADE,
    FOREIGN KEY (adpicture_id) REFERENCES adPictures (id)
        ON DELETE CASCADE,
    UNIQUE (ad_id)
);
...
VALUES (1, 2, 'Leftover Droidikas',
        'Looking to trade some droidika and droidika parts from a cave. serious trades only', 54.1),
       (2, 1, 'Blaster rifles',
        'Sleeping stromtroopers "lost" their blasters. equal value or greater, I know what I have', 33391),
       (3, 2, 'C3PO unit along a R2D2 unit',
        'C3po-series protocol droid to interact with organics, programed primarily for etiquette and protocol. as title. Restraining bolt already attached',
        5464),
       ...
       (11, 9, 'Teaching young Jawas', 'Looking for locations of items of value to help teach new jawas to scrap',
        56575),
       (12, 3, 'Beskar',
        'Extremely rare alloy, Own at your own risk, especially if you have a price on your head without a locator+$$',
        1100000.00),
       (13, 7, 'Hyperdrive-generator',
        'Vital starship engine system that allows light speed travel. This is a must-have system to travel between galaxies. It allows travelers to traverse a galaxy spanning over 120,000 light-years in only few hours or days.',
        123454.23),
       (14, 6, 'Laser-canons',
        'fits most starfighters and starships. Could be fixed in place or attached to a turret. ** mount not included, Snowspeeder in picture not included.',
        2345.98),
       (15, 9, 'Shifter knob', 'Miscellaneous - a Razorcrest shifter', 12.00),
       ...
       (18, 5, 'Speeder bike',
        'Hoverbike open-air repulsolift. Max altitute 10 meter, must have the \'item\' from the Dune-sea', 45009.87),
       (19, 4, 'Gaffi Stick', 'Traditional melee weapon of Tusken Raiders. ', 1232.90),
       (20, 4, 'Gamorrean\'s axe', 'Vibro-ax for Gamorrean warriors. ', 125.90),
...
INSERT INTO adPictures (id, url)
VALUES (1, 'Adsimg/axe.png'),
       (2, 'Adsimg/Beskar.png'),
       (3, 'Adsimg/bobafett-helmet.jpeg'),
       (4, 'Adsimg/droid.jpeg'),
       (5, 'Adsimg/e-web.png'),
       (6, 'Adsimg/gaffi-stick.png'),
       (7, 'Adsimg/hyperdrive-generator.png'),
       (8, 'Adsimg/IG-88.png'),
       (9, 'Adsimg/laser-cannon.png'),
       (10, 'Adsimg/r2d2-c3po.jpeg'),
       (11, 'Adsimg/shifter-knob.jpeg'),
       (12, 'Adsimg/speeder-bike.png');

INSERT INTO ad_picture (ad_id, adpicture_id)
VALUES (1, 4),
       (2, 2),
       (3, 6),
       (4, 1),
